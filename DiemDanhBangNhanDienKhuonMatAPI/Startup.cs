...
namespace DiemDanhBangNhanDienKhuonMatAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Config SQL Database
            services.AddDbContext<DB_DIEMDANHContext>(options =>
             options.UseSqlServer(Configuration.GetConnectionString("DB_DIEMDANH")));
